  ...
  if (collapsed) {
    return (
      <button
        ...
        className="bg-surface/90 border border-muted px-2 py-1 text-[9px] text-muted font-mono hover:border-primary hover:text-primary transition-all flex items-center gap-1"
    ...
    <div className="bg-surface/95 border border-primary/50 shadow-neon p-3 max-w-[260px] backdrop-blur-sm">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-bold text-text-main uppercase tracking-wide">How to Read This Map</span>
        </div>
      ...
      <ul className="space-y-1.5 mb-3">
        <li className="flex items-start gap-2 text-[10px] text-text-main">
